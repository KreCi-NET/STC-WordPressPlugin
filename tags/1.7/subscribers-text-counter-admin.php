	...
	<div style="width: 600px;">
		<div>
            	...
            	<div style="background-color: #DFF2BF; padding: 10px 10px 10px 10px; margin: 3px; border: 2px solid green;">
						...
						/* ]]> */</script>
						<div style="margin: 1px 0 15px 0">
							<a class="FlattrButton" style="display:none;" rev="flattr;button:compact;" href="http://www.kreci.net/code/wordpress/subscribers-text-counter-widget/"></a>
						</div>
						Via PayPal:<br />
			...
			<p>
				...
				<ol style="font-size: 12px;">
					...
					<li>To display counters use following tags: <strong>'twitter', 'facebook', 'youtube', 'wordpress', 'all'</strong></li>
					<li>To display links use following tags: <strong>'twitterlink', 'facebooklink', 'youtubelink'</strong></li>
			...
			<input type="hidden" name="stextcount_hidden" value="settings">
				<div style="background-color: #fff; padding: 10px; margin: 2px; border: 1px solid #E0E0E0;">
					...
					<p>
                                                ...
                                                To get your Consumer key & secret you need to:
                                                <ol style="padding: 5px 0 0 0; font-size: 12px; color: red;">
                                                        ...
                                                        <li>Copy & paste key & secret</li>
                                                </ol>
                                                </div>
					</p>
					twitter handle:
					<input type="text" name="twitter" value="<?php echo $options['twitter']; ?>" size="20"><br />
					<small>ex: "KreCiDev" if url is "<a href="http://www.twitter.com/KreCiDev" target="_blank">http://www.twitter.com/KreCiDev</a>"</small><br />
					Consumer key:
					<input type="text" name="twitterk" value="<?php echo $options['twitterk']; ?>" size="20"><br />
					Consumer secret:
					<input type="text" name="twitters" value="<?php echo $options['twitters']; ?>" size="20">
				</div>
				<div style="background-color: #fff; padding: 10px; margin: 2px; border: 1px solid #E0E0E0;">
